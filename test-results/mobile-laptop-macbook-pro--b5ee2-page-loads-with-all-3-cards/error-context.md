...
- Name: mobile.spec.js >> laptop-macbook-pro-14 >> Pricing page loads with all 3 cards
- Location: tests\mobile.spec.js:61:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/upgrade
Call log:
  - navigating to "http://localhost:5173/upgrade", waiting until "load"
