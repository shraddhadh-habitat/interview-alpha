...
function ScoreDashboard({ data }) {
  ...
  const scoreBg = overall_score >= 70 ? C.greenLight : overall_score >= 40 ? C.yellowLight : C.redLight;
...
// ─── Main App ───
export default function InterviewAlpha() {
  ...
  const globalStyles = `
    @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700;900&family=DM+Mono:wght@300;400;500&family=Source+Serif+4:wght@300;400;600&display=swap');
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @keyframes grain { 0% { transform: translate(0,0); } 10% { transform: translate(-2%,-2%); } 50% { transform: translate(-2%,2%); } 100% { transform: translate(0,0); } }
    ...
    return (
      <div style={{
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", animation: "fadeUp 0.6s cubic-bezier(0.22, 1, 0.36, 1)" }}>
          ...
          <p style={{ fontSize: 13, color: C.textSoft, marginBottom: 40, fontFamily: "'Source Serif 4', serif" }}>The more detail you provide, the sharper the interview gets.</p>
          ...
          <button
            onClick={() => { if (resume.trim() && jd.trim()) setPhase("track"); }}
  ...
  return (
    <div style={{
      ...
      {/* Top accent */}
      <div style={{ position: "fixed", top: 0, left: 0, right: 0, height: 3, background: `linear-gradient(90deg, ${C.orange}, ${C.orangeHover})`, zIndex: 20 }} />
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 18, fontWeight: 700, color: C.text }}>I<span style={{ color: C.orange }}>A</span></span>
          ...
          {voiceMode ? (
            ...
            <>
              ...
              <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 12, marginTop: 10 }}>
                ...
                <span style={{ fontSize: 10, color: C.textMuted, letterSpacing: 1 }}>
                  "End Interview" for your Performance Dashboard
                </span>
              </div>
            </>
          )}
