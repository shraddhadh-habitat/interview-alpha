      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        @media (max-width: 768px) {
          .leadership-container { padding: 32px 16px !important; }
          .leadership-header { padding-bottom: 24px !important; margin-bottom: 32px !important; }
          .leadership-header h1 { font-size: 24px !important; }
          .leadership-header p { font-size: 14px !important; }
          .leadership-bio-section { max-width: 100% !important; margin-bottom: 40px !important; }
          .leadership-name { font-size: 20px !important; }
          .leadership-title { font-size: 12px !important; }
          .leadership-bio-text { font-size: 14px !important; line-height: 1.7 !important; }
          .leadership-bio-text p { word-break: break-word !important; }
          .leadership-links { flex-direction: column !important; gap: 12px !important; }
        }
      `}</style>

      <div className="leadership-container" style={{ width: '100%', maxWidth: 1200, margin: '0 auto', padding: '80px 40px', boxSizing: 'border-box' }}>

        {/* Header */}
        <div className="leadership-header" style={{ textAlign: 'center', marginBottom: 64, width: '100%' }}>
          <h1 style={{
        ...
        <div className="leadership-bio-section" style={{ width: '100%', maxWidth: 680, margin: '0 auto', boxSizing: 'border-box' }}>
          {/* Avatar */}
          ...
          {/* Name and Title */}
          <h2 className="leadership-name" style={{
            fontSize: 22,
            fontWeight: 600,
            color: C.text,
            textAlign: 'center',
          ...
          <p className="leadership-title" style={{
            fontSize: 14,
            color: C.textMuted,
            textAlign: 'center',
            marginBottom: 32,
          ...
          {/* Bio Text */}
          <div className="leadership-bio-text" style={{ width: '100%', fontSize: 16, lineHeight: 1.8, color: C.text, boxSizing: 'border-box', wordBreak: 'break-word' }}>
          ...
          {/* Contact Links */}
          <div className="leadership-links" style={{ width: '100%', marginTop: 40, paddingTop: 32, borderTop: `1px solid ${C.border}`, display: 'flex', gap: 32, justifyContent: 'center', flexWrap: 'wrap', boxSizing: 'border-box' }}>
            <a
