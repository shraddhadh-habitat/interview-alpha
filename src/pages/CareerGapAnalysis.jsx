...
export default function CareerGapAnalysis({ user, profile }) {
  ...
  const quickUsed =
    profile?.gap_analysis_used === true ||
    localStorage.getItem("ia_gap_analysis_used") === "true";
  ...
  const handleAnalyze = async () => {
    ...
    if (!canAnalyze) {
      setError(
        "You have used your free analysis. Upgrade to Pro for unlimited gap analyses.",
      );
      return;
    }
    setLoading(true);
...
Provide 4-6 items per array and 4-5 courses with real working URLs from well-known platforms like Coursera, LinkedIn Learning, Google, PMI, AWS, Udemy, edX.`;
    ...
    try {
      ...
      if (mode === "quick") {
        localStorage.setItem("ia_gap_analysis_used", "true");
        if (user) {
          await supabase
            .from("profiles")
            .update({ gap_analysis_used: true })
            .eq("id", user.id);
        }
      }
      setResult(parsed);
  ...
  if (!mode)
    return (
      ...
      >
        ...
        >
          Find out exactly what stands between you and your target role and what
          to do about it.
        </p>
        ...
        >
          ...
          >
            ...
            >
              Fill in your profile details. Get a comprehensive gap analysis in
              seconds.
            </p>
            <div
              style={{
          ...
          <div
            ...
            onMouseLeave={(e) => {
              e.currentTarget.style.borderColor = "rgba(27,27,24,0.12)";
              e.currentTarget.style.boxShadow = "none";
            }}
          >
            {!isPro && (
            ...
            >
              Paste your resume and the target job description. Get a precise
              gap analysis against the actual role requirements.
            </p>
            <div
              style={{
                fontSize: "12px",
            ...
            >
              • Everything in Quick &nbsp;&nbsp; • Resume vs JD match
              <br />• JD match score &nbsp;&nbsp; • Role-specific courses
            </div>
            {isPro ? (
              <span
                style={{
              ...
              <button
                onClick={(e) => {
                  ...
                  window.dispatchEvent(
                    new CustomEvent("ia:navigate", { detail: "upgrade" }),
                  );
                }}
                style={{
                  background: GRAD,
  ...
  return (
    ...
    >
      ...
      <div style={sectionStyle}>
        ...
        >
          ...
          <div>
            ...
            <input
              style={inputStyle}
              placeholder="e.g. Mastercard, TCS"
              value={form.currentOrg}
              onChange={(e) => set("currentOrg", e.target.value)}
            />
          </div>
          <div>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => set("targetOrg", e.target.value)}
            />
          </div>
          <div>
            ...
            <input
              style={inputStyle}
              placeholder="e.g. Fintech, Consulting"
          ...
          <div style={sectionStyle}>
            ...
            <label
              style={{
                ...
                padding: "12px",
                marginBottom: "12px",
                border: "1.5px dashed rgba(27,27,24,0.2)",
                borderRadius: "12px",
                background: "#FAFAF8",
                cursor: "pointer",
                fontFamily: FONT,
              ...
              onMouseLeave={(e) =>
                (e.currentTarget.style.borderColor = "rgba(27,27,24,0.2)")
              }
            >
              📄 Upload Resume (PDF)
              <input
      ...
      <button
        onClick={() => {
          if (!user) {
            requireAuth("Sign in to analyse your career gap");
            return;
          }
          handleAnalyze();
        }}
      ...
      >
        {loading
          ? "Analysing your career gap..."
          : mode === "deep"
            ? "Run Deep Gap Analysis"
            : "Analyse My Career Gap"}
      </button>
      ...
      {result && (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          {mode === "deep" && result.jd_match_score && (
            <div
              style={{ ...sectionStyle, textAlign: "center", padding: "32px" }}
            >
              <p
                style={{
                  fontSize: "11px",
              ...
              >
                Your resume matches {result.jd_match_score}% of this role's
                requirements
              </p>
            </div>
          )}
          ...
          <div
            style={{
              ...sectionStyle,
              background:
                "linear-gradient(135deg, rgba(168,230,207,0.08), rgba(192,132,252,0.08))",
          ...
          >
            ...
            >
              ⏱ Estimated timeline:{" "}
              <strong style={{ color: "#1B1B18" }}>{result.timeline}</strong>
            </p>
          </div>
          ...
          <div style={sectionStyle}>
            ...
            >
              {result.critical_gaps
                ?.slice(0, isPro ? result.critical_gaps.length : 2)
                .map((g, i) => (
                  <div
                    key={i}
                    style={{
              ...
              {!isPro && result.critical_gaps?.length > 2 && (
                <div style={{ position: "relative", marginTop: 8 }}>
                  ...
                  >
                    {result.critical_gaps.slice(2).map((g, i) => (
                      <div
                        key={i}
                        style={{
                          display: "flex",
                  ...
                  <div
                    style={{
                      ...
                      inset: 0,
                      background:
                        "linear-gradient(to bottom, transparent 0%, rgba(255,255,255,0.95) 40%)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                    }}
          ...
          {isPro ? (
            <div style={sectionStyle}>
              ...
              >
                If a link does not open the course directly, search the course
          ...
          {result.ia_tracks?.length > 0 && (
            ...
            >
              ...
              >
                Practice the interview questions that matter for your target
                role.
              </p>
              <button
                onClick={() =>
                  window.dispatchEvent(
                    new CustomEvent("ia:navigate", { detail: "practice" }),
                  )
                }
                style={{
                  background: GRAD,
          ...
          >
            ...
            >
              This analysis is generated by AI using available online
              information and is intended as a general guide only. Career
              decisions are complex and individual. InterviewAlpha.in does not
              guarantee the accuracy of this analysis and is not responsible for
              career outcomes based on it. We recommend validating these
              insights with a career coach or industry professional.
            </p>
          </div>
        </div>
      )}
