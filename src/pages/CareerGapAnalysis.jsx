    ...
    <div style={{ maxWidth: '760px', margin: '0 auto', padding: isMobile ? '24px 16px' : '32px 24px', fontFamily: FONT }}>
      ...
      {result && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {result.critical_gaps?.map((g, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', fontSize: '14px', color: '#1B1B18', lineHeight: 1.6, fontFamily: FONT }}>
                  <span style={{ color: '#CF222E', flexShrink: 0, marginTop: '1px' }}>•</span>
                  {g}
                </div>
              ))}
            </div>
          ...
          {/* Disclaimer */}
          <div style={{ borderTop: '1px solid rgba(27,27,24,0.1)', paddingTop: '24px', marginTop: '32px' }}>
            <p style={{ fontSize: '11px', color: 'rgba(27,27,24,0.4)', lineHeight: 1.7, fontFamily: FONT, margin: 0 }}>
              This analysis is generated by AI using available online information and is intended as a general guide only. Career decisions are complex and individual. InterviewAlpha.in does not guarantee the accuracy of this analysis and is not responsible for career outcomes based on it. We recommend validating these insights with a career coach or industry professional.
            </p>
          </div>
        </div>
      )}
