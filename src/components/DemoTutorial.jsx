...
const STEPS = [
  {
    ...
    body: `InterviewAlpha gives you everything you need to land your next PM role — from live mock interviews with real-time feedback, to a 300+ question practice bank covering every level from APM to CPO.\n\nThis 60-second tour will show you what's waiting for you.`,
  },
  {
    id: 'profile',
    icon: '⊡',
