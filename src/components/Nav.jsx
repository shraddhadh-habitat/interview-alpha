...
const C = {
  ...
  textLight: 'rgba(27, 27, 24, 0.5)',
  border: 'rgba(27, 27, 24, 0.12)',
  bgMuted: '#FAFAF8',
  green: '#1B1B18',
  greenHover: '#0A0A0A',
  greenLight: 'rgba(27, 27, 24, 0.08)',
  greenBorder: 'rgba(27, 27, 24, 0.12)',
  red: '#1B1B18',
  redLight: 'rgba(27, 27, 24, 0.08)',
  redBorder: 'rgba(27, 27, 24, 0.12)',
  yellow: '#FDCD34',
  yellowLight: 'rgba(253, 205, 52, 0.12)',
  yellowBorder: 'rgba(253, 205, 52, 0.2)',
  orange: '#1B1B18',
};
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Center tabs */}
        <div className="nav-tabs" style={{ flex: '1 1 auto', justifyContent: 'flex-start', margin: '0 24px', minWidth: 0, paddingRight: 16, zIndex: 1 }}>
          {tabs.map(tab => (
            <button
              key={tab.id}
