  ...
  return (
    <footer style={{
      ...
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        <p style={{ fontSize: 12, color: '#666666', margin: '0 0 10px', letterSpacing: 0.3 }}>
          © 2026 InterviewAlpha™. All rights reserved.
        </p>
        <p style={{ fontSize: 11, color: '#666666', lineHeight: 1.75, margin: '0 0 10px', letterSpacing: 0.2 }}>
        ...
        <p style={{ fontSize: 11, color: '#666666', lineHeight: 1.75, margin: '0 0 22px', letterSpacing: 0.2, maxWidth: 720, marginLeft: 'auto', marginRight: 'auto' }}>
        ...
        <div style={{ display: 'flex', gap: 20, justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap' }}>
          <a href="#" style={{ fontSize: 12, color: '#888888', textDecoration: 'none', letterSpacing: 0.5 }}
